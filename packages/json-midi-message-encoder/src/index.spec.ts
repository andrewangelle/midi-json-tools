...
function transformBufferToArray(arrayBuffer: ArrayBufferLike) {
...
describe('encodeMidiEvent', () => {
  ...
  it('should encode a channel pressure event', () => {
    ...
    expect(transformBufferToArray(arrayBuffer)).to.deep.equal([212, 46]);
  });
  ...
  it('should encode a key pressure event', () => {
    ...
    expect(transformBufferToArray(arrayBuffer)).to.deep.equal([164, 54, 46]);
  });
